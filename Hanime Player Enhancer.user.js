...
(function() {
    ...
    function enhancePlayerInteractions() {
        ...
        overlay.style.cssText = 'position: absolute; top: 10%; left: 0; width: 100%; height: 55%; display: flex; z-index: 999; pointer-events: none;';
        ...
        center.style.cssText = 'flex: 1; pointer-events: none;';

        const right = document.createElement('div');
        right.style.cssText = zoneStyle;
        right.onclick = () => {
            video.currentTime += 10;
            showFeedback('+10s', video.parentElement);
        };
